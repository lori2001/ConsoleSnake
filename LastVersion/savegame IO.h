...
void printsavegame()
{
   savegame = fopen("savegame.t", "w"); //http://web.cs.swarthmore.edu/~newhall/unixhelp/C_files.html
  ...
  else
  {
     ...
     fprintf (savegame,  "\x0A");
     fprintf (savegame,"Won by %s", player9);
     fprintf (savegame,  "\x0A");
     fprintf (savegame,"____________________________________________");
...
void scansavegame()
{
    savegame = fopen("savegame.t", "r"); //http://web.cs.swarthmore.edu/~newhall/unixhelp/C_files.html

    if (savegame == NULL)
    {
     fclose  (savegame);
     savegame = fopen("savegame.t", "w");
